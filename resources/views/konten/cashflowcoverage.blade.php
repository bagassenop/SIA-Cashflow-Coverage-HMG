...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
            @if ($year == null)
                <h1>Cashflow Coverage</h1>
            @else
                <h1>Cashflow Coverage {{ $year }}</h1>
            @endif
        </div><!-- /.col -->
        <div class="col-sm-5">
        </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
        <div class="card">
            <form action="/cashflow-coverage/filter" method="post">
                @csrf
                <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                            <tr>
                                ...
                                <td>{{ $kas->nominal + $bank->nominal }}</td>
                                <td>{{ $totalKewajibanLancar + $totalKewajibanJangkaPanjang }}</td>
                                <td>{{ $cashflow }}</td>
                            </tr>
                    </tbody>
                </table>
